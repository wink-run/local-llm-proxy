...
PROVIDER_CATALOG = [
    ...
    {"id": "agnes-ai", "type": "free", "enabled_default": False, "base_url": "https://apihub.agnes-ai.com/v1",
     "icon": "🤍", "label": "Agnes AI", "hint": "OpenAI 兼容接口：agnes-ai.com", "keyless": False,
     "key_prefix": ["sk-"], "signup_url": "https://platform.agnes-ai.com/settings/apiKeys"},
    {"id": "groq", "type": "free", "enabled_default": False, "base_url": "https://api.groq.com/openai/v1",
     "icon": "⚡", "label": "Groq", "hint": "免费额度大、超快推理：console.groq.com", "keyless": False,
    ...
    {"id": "cerebras", "type": "free", "enabled_default": False, "base_url": "https://api.cerebras.ai/v1",
     "icon": "🧠", "label": "Cerebras", "hint": "免费额度、极速推理：cloud.cerebras.ai", "keyless": False,
     "key_prefix": ["csk-"], "signup_url": "https://cloud.cerebras.ai/platform"},
    {"id": "github-models", "type": "free", "enabled_default": False, "base_url": "https://models.github.ai/inference",
     "icon": "🐙", "label": "GitHub Models", "hint": "GitHub 账号免费额度（用 PAT）", "keyless": False,
    ...
    {"id": "mistral", "type": "paid", "enabled_default": False, "base_url": "https://api.mistral.ai/v1",
     "icon": "🌬", "label": "Mistral", "hint": "官方付费 API：console.mistral.ai", "keyless": False,
     "key_prefix": [], "signup_url": "https://console.mistral.ai/api-keys"},
    {"id": "together", "type": "paid", "enabled_default": False, "base_url": "https://api.together.xyz/v1",
     "icon": "🔗", "label": "Together AI", "hint": "开源模型托管：together.ai", "keyless": False,
     "key_prefix": [], "signup_url": "https://api.together.xyz/settings/api-keys"},
    {"id": "cohere", "type": "paid", "enabled_default": False, "base_url": "https://api.cohere.ai/compatibility/v1",
     "icon": "🔵", "label": "Cohere", "hint": "付费 API、有免费试用：cohere.com", "keyless": False,
